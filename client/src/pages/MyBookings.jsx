...
const MyBookings = () => {
  ...
  const currcency = import.meta.env.VITE_CURRENCY
      ...
      {bookings.map((item, index) => (
        ...
        bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
          <div className='flex flex-col md:flex-row'>
            <img src={item.show.movie.poster_path} className='md:max-w-45 aspect-video
            h-auto object-cover object-bottom rounded' alt="" />
          ...
          <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
            <div className='flex items-center gap-4'>
              <p className='text-2xl font-semibold mb-3'>{currcency}{item.amount}</p>
